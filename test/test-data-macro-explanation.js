...
exports["test doc dataMacroExplanation"] = function testDataMacroExplanation(assert, done) {
  const tests = [
    {
  ...
  runTests(assert, done, "dataMacroExplanation", "data macro explanation", url, tests);
};
